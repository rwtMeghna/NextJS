...
const Hero = () => {
  return (
   ...
   <h2 className='uppercase tracking-wide text-xs text-center text-blue- max-w-80'>Dynamic web Magic with Nextjs</h2>
   <TextGenerateEffect
  ...
  Welcome I am Megha,<br/>  Full Stack developer
   </p>
